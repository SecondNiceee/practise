  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "Простая визитная карточка с логотипом «Кибитка» и контактными данными.",
      },
    ],
  },
  {
      ...
      <div className="mx-auto max-w-6xl px-5 py-16 md:py-24">
        ...
        <div className="mb-12 rounded-2xl border border-brand-orange/20 bg-brand-orange/5 p-5 md:p-6">
          <p className="text-sm leading-relaxed text-brand-navy">
            <span className="font-semibold">Примечание:</span> В большинстве носителей цветовое решение не прописано. Основой являются <span className="font-semibold">графические элементы</span> логотипа и <span className="font-semibold">фотостиль</span>, которые обеспечивают узнаваемость бренда независимо от цветовой палитры. Цвет используется выборочно для акцентов и деталей.
          </p>
        </div>
