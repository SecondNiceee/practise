...
export function PhotoStyleSection() {
  return (
    <section id="photostyle" className="scroll-mt-20">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-2xl border border-brand-navy/10 bg-card p-6">
            ...
            <p className="text-sm text-brand-navy/70">
              Естественный свет, тёплые тона. Золотой час (рассвет/закат) идеален для съёмок.
              Избегать резких теней и холодного искусственного освещения.
            </p>
          </div>
          <div className="rounded-2xl border border-brand-navy/10 bg-card p-6">
            ...
            <p className="text-sm text-brand-navy/70">
              ...
              Мягкий контраст, сохранение деталей в тенях.
            </p>
          </div>
          <div className="rounded-2xl border border-brand-navy/10 bg-card p-6">
